...
public class BloodSugarValidationMessages {
	...
	public static final String REQUIRED_MEASUREMENT_TYPE = "측정 타입 유형은 필수입니다.";
	public static final String INVALID_MEASUREMENT_TYPE = "측정 타입을 확인해 주세요.";

	public static final String REQUIRED_MEAL_TYPE = "식사 유형은 필수입니다.";
	public static final String INVALID_MEAL_TYPE = "식사 유형을 확인해 주세요.";
